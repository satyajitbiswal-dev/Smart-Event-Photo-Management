...
@shared_task
def send_event_member_mail(event,pk_set):
    ...
    if event.event_coordinator_id in pk_set:
        ...
        send_mail(subject=subject,message=event_coordinator_message,from_email=from_email,recipient_list = [event.event_coordinator_email])
    ...
    if event.event_photographer_id in pk_set:
        ...
        send_mail(subject=subject,message=event_photographer_message,from_email=from_email,recipient_list = [event.event_photographer_email])
