...
import { Avatar, Box, Button, Card, CardActions, CardContent, CardHeader, CardMedia, Grid, IconButton, Menu, MenuItem, Tooltip, Typography, useMediaQuery } from '@mui/material'
...
const Event = () => {
    ...
    const is1200Up = useMediaQuery("(min-width:1200px)");
